...
var searchCity = function () {
  ...
  var userCity = document.createElement('button');
  userCity.textContent = userSearch;
  userCity.className = 'btn btn-secondary';
...
var displayWeather = function (data) {
  ...
  tempEl.textContent =
    userSearch + "'s Current Temperature: " + data.current.temp + '°F';
  ...
  data.forEach(function (item) {
    ...
    <div class="">
      <div class="">
        ...
        <img src=""alt = "weather forecast icon"id = ${item.dt_txt.slice(
          0,
          10
        )}>
